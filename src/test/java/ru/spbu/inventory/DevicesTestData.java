...
public class DevicesTestData {
    ...
    public static Device getNew() {
        return new Device(null, "new.pu.ru", "ELTEX", "XX11", "IN01", new Date(119, 9, 9)
                , "new dev", "new contact");
    }
