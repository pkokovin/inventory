...
import ru.spbu.inventory.util.exception.ErrorInfo;
...
import static ru.spbu.inventory.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        ...
        if (rootMsg != null) {
            ...
            boolean flag = false;
            flag = lowerCaseMsg.contains("users_unique_email_idx");
            if (flag) {
